...
gdjs.evtsExt__Jump3D__TopZ.userFunc0xc3d3d8 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length === 0) {
    return;
}
...
gdjs.evtsExt__Jump3D__TopZ.userFunc0xc3d3d8(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
